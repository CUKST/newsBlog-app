...
public class TechnologyAdapter extends RecyclerView.Adapter<TechnologyAdapter.ViewHolder> {
    ArrayList<Technology> newsList3;
    Context context;
   Technology news;
    public TechnologyAdapter(ArrayList<Technology> newsList, Context context) {
       ...
       holder.newsArthur.setText(news.newsArthur);
        ...
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(context, WebForTech.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                WebForTech.url =news.url;
